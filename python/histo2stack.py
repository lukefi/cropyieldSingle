...
Make histo-files into one array stack.
...
mergeAllGetNumpyArrays() makes one big dataframe for one year. Save to temp.

testing(outputfile) tests if output file is ok.

RUN: 

python histo2stack.py -i /Users/myliheik/Documents/myCROPYIELD/scratch/project_2001253/histo_test1110_2016 -n 32 -o /Users/myliheik/Documents/myCROPYIELD/dataStack -f test1110_2016.pkl 
...
def main(args):
    ...
    try:
        ...
        # temp directory for temp annual histograms:
        data_folder2 = datadir + "_temp"
